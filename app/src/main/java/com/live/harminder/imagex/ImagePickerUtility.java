...
public abstract class ImagePickerUtility extends BaseActivity {
    Activity activity;
    ...
    private void uploadImage() {
        final Dialog uploadImage = new Dialog(activity, R.style.Theme_Dialog);
        ...
        if (requestCode == requestCodeCamera && resultCode == Activity.RESULT_OK) {
            ...
            try {
                ...
                if (resultCode == AppCompatActivity.RESULT_OK) {
                    ...
                    if (uri != null) {
                        imgPath = Common.getPath(activity, uri);//CommonMethods.getPath(activity, uri);
